...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Users</span> <span class="label label-important"></span></a>
      <ul>
        <li><a href="{{url('/admin/viewUsers')}}">Users</a></li>
        <li><a href="form-common.html">Admin</a></li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Orders</span> <span class="label label-important"></span></a>
      <ul>
        <li><a href="{{url('/admin/pending-orders')}}">Pending Orders</a></li>
        <li><a href="{{url('/admin/accepted-orders')}}">Accepted Orders</a></li>
        <li><a href="{{url('/admin/working-orders')}}">Working Orders</a></li>
        <li><a href="{{url('/admin/completed-orders')}}">Completed Orders</a></li>
