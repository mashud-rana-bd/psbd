                ...
                <div class="container box_1620">
                    <div class="banner_inner d-flex align-items-center justify-content-center">
                         <div class="banner_content" >
                            ...
                            <div class="card-header d-flex align-items-center justify-content-center" style="margin-bottom:30px"><h2>Free Trial</h2> </div>
                            ...
                            <div class="col-md-12" >
                                ...
                                <form name="order" id="order" action="{{ url('free-trial-submit')}}" method="post" style="padding: 5px"  enctype="multipart/form-data">{{csrf_field()}}
                                    ...
                                    <div class="bg-info">
                                            <div class="container">
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-11 main-section">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="file" id="file-1" name="file[]" multiple class="file" data-overwrite-initial="false" data-show-upload="false" data-max-file-count="2">
                                                    </div>
                                                </div>
